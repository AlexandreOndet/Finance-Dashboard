...
export const I18N = {
  en: {
    ...
    settings: 'Market data', apiKey: 'Twelve Data API key', apiKeyPlaceholder: 'Paste your free API key',
    apiKeyHelp: 'Your key is stored only in this browser (localStorage) and never sent anywhere but Twelve Data.',
    getKey: 'Get a free key', refresh: 'Refresh prices', refreshing: 'Refreshing…',
    lastUpdated: 'Prices updated', never: 'never', usingSample: 'Using sample prices — add an API key for live data.',
    livePrices: 'Live prices active', sourceNote: 'Free Twelve Data feed · cached ~24h · ≤1 day old is fine.',
    fxRate: 'USD → CAD', clearKey: 'Remove key', save: 'Save', close: 'Close',
  ...
  fr: {
    ...
    settings: 'Données de marché', apiKey: 'Clé API Twelve Data', apiKeyPlaceholder: 'Collez votre clé API gratuite',
    apiKeyHelp: "Votre clé est stockée uniquement dans ce navigateur (localStorage) et n'est envoyée qu'à Twelve Data.",
    getKey: 'Obtenir une clé gratuite', refresh: 'Actualiser les cours', refreshing: 'Actualisation…',
    lastUpdated: 'Cours mis à jour', never: 'jamais', usingSample: "Cours d'exemple — ajoutez une clé API pour les données en direct.",
    livePrices: 'Cours en direct actifs', sourceNote: 'Flux gratuit Twelve Data · en cache ~24 h · ≤ 1 jour suffit.',
    fxRate: 'USD → CAD', clearKey: 'Retirer la clé', save: 'Enregistrer', close: 'Fermer',
